...
public class LocomotiveSourceDQ2Pane implements UIFormPane{
	...
	public void writePane(UIFormPaneWriter pWriter, UIFormContext aContext) {
		...
		Query<Tuple> locoQueryTuple = adaptationDataset.createQuery(locoQuery);
		...
		for (Tuple locoResult : locoRecords) {
			...
			//System.out.println("===Loco Record==="+locoRecord.get(Paths._Root_Locomotive._Root_Locomotive_Loco_Number));
